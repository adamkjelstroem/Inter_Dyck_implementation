...
//	public static boolean outOfBudget = false;
	...
	static {
		...
		DEBUG = !("0".equals(System.getProperty("Debug")));/*true;*/
		...
		System.out.println("May alias is "+MAY_ALIAS+"   Debug is "+DEBUG+"   use_cache is "+USE_CACHE+"  use_summary is "+USE_SUMMARY);
